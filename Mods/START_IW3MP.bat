...
:launch
cd ../
start iw3mp.exe +set fs_game "%modname%" +set sv_punkbuster 0 +set cl_punkbuster 0 +set r_custommode "1920x1080" +set r_aspectratio 3 +set r_fullscreen 0 +set r_noborder 0 +set developer 0 +set developer_script 0
